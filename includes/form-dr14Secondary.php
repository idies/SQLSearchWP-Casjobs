					...
					<div class="col-xs-12 col-sm-12 col-md-6 text-center">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 text-center">
								...
								<textarea id="sqls-query-'.$num.'" name="cmd" class="sqls-query" style="color: '.$color.'" data-colnum=60 rows=10 cols=30 disabled>select top 10 p.objid, p.ra, p.dec, p.g, p.r, s.z from photoObj p
