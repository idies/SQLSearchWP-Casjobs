			...
			<div class="form sqls-form">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6 text-center">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 text-center">
								<button name="sqls-edit" class ="sqls-edit btn btn-primary btn-dr14" data-unlock="yes">Unlock</button>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-6 text-center">
								<button name="sqls-syntax" data-sqls-submitto="http://skyserver.sdss.org/dr14/en/tools/search/x_results.aspx?searchtool=SQL&TaskName=Skyserver.Search.SQL&ReturnHtml=true&format=html&syntax=Syntax&cmd=" class="sqls-syntax btn btn-warning btn-dr14">Check Syntax</button>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 text-center">
								<p><strong>QUERY DR14</strong></p>
								<div class="sqls-lock" style=""><span class="glyphicon glyphicon-lock"></span></div>
								<textarea name="cmd" class="sqls-query" style="color: '.$color.'" data-colnum=60 rows=10 cols=30 disabled>select top 10 p.objid, p.ra, p.dec, p.g, p.r, s.z from photoObj p
...
and p.dec between -0.1 and 0.1</textarea>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 text-center">
								<button name="sqls-reset" class="sqls-reset btn btn-danger btn-dr14">Reset</button>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-6 text-center">
								<button name="sqls-submit" class="sqls-submit btn btn-success btn-dr14">Submit</button>
								<div class="checkbox">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 text-center">
						<div class="sqls-results-wrap">
							...
							<div class="sqls-hour" style="display: none;"><span class="glyphicon glyphicon-hourglass"></span></div>
							<div id="sqls-results-outer-'.$num.'" class="sqls-results-outer collapse">
								<div class="sqls-results"></div>
								<button style="display:none;" name="sqls-download" class ="sqls-download btn btn-primary btn-dr14">Download</button>
							</div>
						</div>
					</div>
				</div>
